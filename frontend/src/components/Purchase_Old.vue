...
onMounted(async () => {
 ...
 // configuración boton bold
  ...
  const redirectionUrl = 'https://avabot-3b5c6.web.app'
...
const customer = {
  email: 'formData@gnail.com',
  fullName: 'ormData.value.name',
  phone: '3173499781',
  dialCode: '+57',
  documentNumber: '123456789',
  documentType: 'CC'
...
script.setAttribute('data-customer-data', JSON.stringify(customer));
